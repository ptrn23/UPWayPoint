/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: fecedc55a277947d3c78aa6404cf213a)
...
declare namespace Cloudflare {
	interface Env {
		...
		S3_API: string;
		R2_TOKEN: string;
		WORKER_SELF_REFERENCE: Fetcher /* up-waypoint */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_MAPS_API_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "S3_API" | "R2_TOKEN">> {}
}
