		...
		>
			...
			<div className="flex justify-between items-start">
				<div className="flex flex-col gap-1">
					<h2 className="font-chakra text-[20px] font-extrabold text-primary m-0">{pin?.title}</h2>
					<span className="font-cubao-wide text-[11px] uppercase tracking-[0.1em]" style={{ color: color }}>
			...
			{/* BODY */}
			<div>
				<p className="font-nunito text-[14px] text-primary m-0 leading-relaxed">{pin?.description}</p>
			</div>
